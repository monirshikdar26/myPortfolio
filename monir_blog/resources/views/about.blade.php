              ...
              <div class="col-md-6">
                <div class="row">
                  <div class="col-sm-6 col-md-5">
                    <div class="about-img">
                      <img src={{asset('images/monir.jpg')}} class="img-fluid rounded b-shadow-a" alt="">
                    </div>
                  </div>
                  <div class="col-sm-6 col-md-7">
                    <div class="about-info">
                      <p><span class="title-s">Name: </span> <span>Maniruzzaman</span></p>
                      <p><span class="title-s">Profile: </span> <span>full stack developer</span></p>
                      <p><span class="title-s">Email: </span> <span>manir.zaman@seu.edu.bd</span></p>
                      <p><span class="title-s">Phone: </span> <span>01725-907 215</span></p>
                    </div>
                  </div>
                </div>
                <div class="skill-mf">
